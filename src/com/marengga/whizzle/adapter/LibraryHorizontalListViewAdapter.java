...
public class LibraryHorizontalListViewAdapter extends AdapterView<ListAdapter> {
	...
	public LibraryHorizontalListViewAdapter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	private DataSetObserver mDataObserver = new DataSetObserver() {
		...
		public void onChanged() {
			synchronized(LibraryHorizontalListViewAdapter.this){
				mDataChanged = true;
			}
			invalidate();
			requestLayout();
	...
	private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
		...
		public boolean onDown(MotionEvent e) {
			return LibraryHorizontalListViewAdapter.this.onDown(e);
		}

		@Override
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
				float velocityY) {
			return LibraryHorizontalListViewAdapter.this.onFling(e1, e2, velocityX, velocityY);
		}
		...
		public boolean onSingleTapConfirmed(MotionEvent e) {
			//Toast.makeText(getContext(), "Single Tap Confirmed - akm", Toast.LENGTH_SHORT).show();
			for(int i=0;i<getChildCount();i++){
				View child = getChildAt(i);
			...
			for (int i = 0; i < childCount; i++) {
				...
				if (isEventWithinView(e, child)) {
					if (mOnItemLongClicked != null) {
						mOnItemLongClicked.onItemLongClick(LibraryHorizontalListViewAdapter.this, child, mLeftViewIndex + 1 + i, mAdapter.getItemId(mLeftViewIndex + 1 + i));
					}
					break;
				}
